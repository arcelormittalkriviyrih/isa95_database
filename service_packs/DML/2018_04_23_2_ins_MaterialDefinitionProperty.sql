...
left join [MaterialDefinitionProperty] MDP
on MDP.[Description] = MCP.[Description] and MD1.[ID] = MDP.[MaterialDefinitionID]
where  MC.[Description] = N'Лом' and MD.[MaterialDefinitionID] is null and MCP.[Description] = N'Вид лома' and MDP.ID is null
